...
export class ReviewControllerService {
  ...
  public create(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Review>>;
  public create(
    body: Review,
    id: number,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Review>>;
  public create(
    body: Review,
    id: number,
    observe: any = 'body',
    ...
    return this.httpClient.request<Review>(
      'post',
      `${this.basePath}/review/${encodeURIComponent(String(id))}`,
      {
        body: body,
  ...
  public getReviewByUserId(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<Review>>>;
  public getReviewByUserId(
    usersId: number,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<Review>>>;
  public getReviewByUserId(
    usersId: number,
    observe: any = 'body',
    reportProgress: boolean = false
    ...
    if (usersId === null || usersId === undefined) {
      throw new Error(
        'Required parameter usersId was null or undefined when calling getReviewByUserId.'
      );
    }
  ...
  public getReviewsByActivityId(
    ...
    if (activityId === null || activityId === undefined) {
      throw new Error(
        'Required parameter activityId was null or undefined when calling getReviewsByActivityId.'
      );
    }
